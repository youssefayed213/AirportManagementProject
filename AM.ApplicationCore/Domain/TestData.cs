...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Flight flight1 = new Flight
        {
            ...
            //Passenengers = new List<Passenger> { captain, hostess1, hostess2, traveller1, traveller2, traveller3, traveller4, traveller5 }
            
            Departure="Sousse",
            AirlineLogo="Bouha",
            Plane = Airbusplane
        };
        public static Flight flight2 = new Flight { FlightDate = new DateTime(2022, 02, 01, 21, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105,
            Departure = "KH",
            AirlineLogo = "AAA",
            Plane = BoingPlane };
